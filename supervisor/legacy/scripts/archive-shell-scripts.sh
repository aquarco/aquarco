...
log "     sudo cp supervisor/systemd/aquarco-supervisor-python.service \\"
log "              /etc/systemd/system/aquarco-supervisor.service"
log "     sudo systemctl daemon-reload"
log "     sudo systemctl restart aquarco-supervisor"
log ""
